...
const CompetencyAllowanceRate = () => {
    const { isLoading, isError, data } = useQuery(["allowanceRate", "CompetencyAllowance"], () => AllowanceRateService.getAllowanceRateByAllowanceType("CompetencyAllowance"));
    ...
    const displayEditAllowanceRateForm = () => {
        return <EditAllowanceRateForm allowanceRate={currentSelectedAllowanceRate} allowanceType="CompetencyAllowance" setDisplayModal={setDisplayModal} />;
    };
...
export default CompetencyAllowanceRate;
