...
const InvigilatorViewAllAllowanceClaim = () => {
    const { user } = useAuth();
    const toastRef = useRef(null);
    const { isLoading, isError, data } = useQuery(["allowanceClaimsByUser", user._id], () => AllowanceClaimService.getAllowanceClaimByUser(user._id));
...
export default React.memo(InvigilatorViewAllAllowanceClaim);
