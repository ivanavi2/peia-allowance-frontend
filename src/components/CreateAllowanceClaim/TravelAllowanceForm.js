...
const TravelAllowanceForm = ({ user }) => {
    ...
    const onUpload = useCallback(
        ...
        [getValues, mutate, calculateTotalEligibleAllowance]
    );
            ...
            >
                <div className="p-fluid formgrid grid">
                    ...
                    <div className="col-12 xl:col-2 xl:pt-4 pb-4 xl:pb-0">
                        <Button label="Show calculation" icon="pi pi-external-link" type="button" onClick={() => setDisplayCalculationModal(true)} />
                    ...
                    <div className="md:col-3 my-2 ml-2 md:ml-0">
                        <Button
                            label="Submit"
                            type="submit"
                            loading={isLoadingAddAllowanceClaim || isLoadingAllowanceRate || isLoadingAutoCompleteSuggestions || isFetchingDistance || isUploading}
                            disabled={isErrorAllowanceRate}
                        ></Button>
                    </div>
                </div>
            </form>
