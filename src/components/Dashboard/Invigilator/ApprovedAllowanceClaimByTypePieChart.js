...
const ApprovedAllowanceClaimByTypePieChart = () => {
    ...
    const { isLoading, isError, data } = useQuery(["approvedAllowanceClaimAmountByType", user._id], () => AllowanceClaimService.getInvigilatorApprovedAllowanceClaimAmountCurrentYearByType(user._id), {
